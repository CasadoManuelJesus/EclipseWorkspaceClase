...
public class BusquedaMayor {
	public static void main(String[] args) {
		...
		//Resultados
		System.out.println("Mayor sin hilos: "+mayorSinHilos+"En un tiempo de: "+(finSinHilos-inicioSinHilos)+" milisegundos");
		System.out.println("Mayor con hilos: "+mayorConHilos+"En un tiempo de: "+(finConHilos-inicioConHilos)+" milisegundos");
